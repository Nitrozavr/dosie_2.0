(function($) {
  $.fn.simplePopupp = function(event) {
    var simplePopup = {
      settings: {
        hashtag: "#/",
        url: "popup",
...
/*ДЛЯ КОРРЕКТНОЙ РАБОТЫ СИСТЕМА СТАТУС*/

(function ($) {
    $.fn.simplePopup2 = function (event) {
        var simplePopup = {
            settings: {
                hashtag: "#/",
                url: "popup2",
            ...
            initialize: function (link) {
                ...
                // We redefine the variables if there is an additional popap
                if (name !== "start2") {
                    name = name.replace("_start2", "_popup");
                    popup = $(".js__" + name);
                    routePopup = simplePopup.settings.hashtag + name;
                };
...
(function ($) {
    $.fn.simplePopup3 = function (event) {
        ...
        var simplePopup = {
            ...
            initialize: function (link) {
                ...
                // We redefine the variables if there is an additional popap
                if (name !== "start3") {
                    name = name.replace("_start3", "_popup");
                    popup = $(".js__" + name);
                    routePopup = simplePopup.settings.hashtag + name;
                };
